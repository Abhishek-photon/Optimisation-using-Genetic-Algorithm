...
% %% Problem Definition for cf1
%  
%  CostFunction = @(x) cf1(x);     % Cost Function
%  
...
%  
% 
% % %% Problem Definition for cf2
 
 CostFunction = @(x) cf2(x);     % Cost Function
...
for it = 1:MaxIt
    ...
    %BestVal(it) = BestSol.Position;
    
    % Show Iteration Information
    %disp(['Iteration no. ' num2str(it) ': Best Cost = ' num2str(BestCost(it))]);
    %disp(['Values = ' num2str(BestVal(it))]);
    
    
    disp(['Iteration no. ' num2str(it) ': Best Cost = ' num2str(BestSol.Cost) 'Values = ' num2str(BestSol.Position)]);
